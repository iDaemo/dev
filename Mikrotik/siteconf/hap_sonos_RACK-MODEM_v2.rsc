...
/interface wireless
set wlan2 band=5ghz-a/n/ac channel-width=20/40mhz-eC country=thailand antenna-gain=2 disabled=no mode=ap-bridge wmm-support=enabled wps-mode=disabled ssid=@SonosLibraControl security-profile=profile1 frequency=5785
#set wlan1 band=2ghz-g/n channel-width=20mhz country=thailand antenna-gain=2 disabled=no mode=ap-bridge wmm-support=enabled wps-mode=disabled ssid=@SonosLibraControl2.4G security-profile=profile1 frequency=2452

/interface wireless security-profiles
#set [ find default=yes ] supplicant-identity=SonosLibra
#/interface wireless security-profiles
#set [ find default=yes ] supplicant-identity=MikroTik
#add authentication-types=wpa2-psk mode=dynamic-keys name=33338888 supplicant-identity=""
#/interface wireless
...
# /interface wireless security-profiles
set [ find default=yes ] supplicant-identity=MikroTik
add authentication-types=wpa-psk,wpa2-psk eap-methods="" group-key-update=1h management-protection=allowed mode=dynamic-keys name=profile1 supplicant-identity="" wpa-pre-shared-key="33338888" wpa2-pre-shared-key="33338888"
#/interface wireless
...
add include=InterfaceListVlan11,InterfaceListVlan12,InterfaceListVlan100 name=LOCAL-BRIDGE
...
add interface=ether2 list=InterfaceListVlan11
add interface=ether3 list=InterfaceListVlan11
...
add interface=wlan1 list=InterfaceListVlan11
