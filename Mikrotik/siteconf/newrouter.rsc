/interface/wifiwave2
set wifi1 disabled=no configuration.country=Thailand configuration.ssid=@Controla security.authentication-types=wpa2-psk,wpa3-psk security.passphrase=8-63_characters
