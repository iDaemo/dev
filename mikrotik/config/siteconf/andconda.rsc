...
add interface=ether5 list=InterfaceListVlan1001
...
/ip pool
add name=POOL101 ranges=192.168.30.110-192.168.30.120
add name=POOL102 ranges=192.168.31.110-192.168.31.120
add name=POOL100 ranges=192.168.32.110-192.168.32.120
/ip dhcp-server
...
/ip address
add address=192.168.31.1/24 interface=VLAN101 network=192.168.31.0
add address=192.168.32.1/24 interface=VLAN102 network=192.168.32.0
add address=192.168.30.1/24 interface=VLAN100 network=192.168.30.0
