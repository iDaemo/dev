# 2024-03-02 22:40:15 by RouterOS 7.13.3
...
/interface wifi set [ find default-name=wifi2 ] channel=smart channel.band=2ghz-n .frequency=2462 .width=20/40mhz-eC configuration.country=Thailand .mode=station .ssid="smart 3-3" disabled=no
/interface wifi security add authentication-types=wpa3-psk disabled=no name=idaemon passphrase=thaigaming
...
/interface wifi set [ find default-name=wifi1 ] channel=5GAX configuration=5G configuration.mode=ap disabled=no security=idaemon security.passphrase=thaigaming
/interface wifi add configuration=2G configuration.mode=ap disabled=no mac-address=4A:A9:8A:22:5F:3F master-interface=wifi1 name=wifi3 security=idaemon
...
/ip dhcp-client add interface=wifi2
