...
add name=ch-2ghz frequency=2412,2437,2462 band=2ghz-n width=20mhz skip-dfs-channels=all
add name=ch-5ghz frequency=5180,5260,5500 band=5ghz-ac width=20/40/80mhz skip-dfs-channels=all
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=ap-and-client-mode antenna-gain=2 band=2ghz-onlyn \
    ...
    mode=ap-bridge multicast-buffering=disabled multicast-helper=disabled skip-dfs-channels=all \
    ssid=@SOUDCONTROLsonosxaura wireless-protocol=802.11 wmm-support=enabled wps-mode=disabled security-profile=sonos
set [ find default-name=wlan2 ] adaptive-noise-immunity=ap-and-client-mode antenna-gain=2 band=5ghz-onlyac \
    channel-width=20/40mhz-Ce country=thailand disabled=no frequency=5520 frequency-mode=regulatory-domain installation=indoor \
    mode=ap-bridge multicast-buffering=disabled multicast-helper=disabled skip-dfs-channels=all \
    ssid=@SOUDCONTROLsonosxaura wireless-protocol=802.11 wmm-support=enabled wps-mode=disabled security-profile=sonos
...
/ip pool add name=POOL40 ranges=192.168.40.10-192.168.40.220
